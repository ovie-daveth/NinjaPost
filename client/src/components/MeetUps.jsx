...
const MeetUps = () => {
  ...
  return (
    <div className=' flex flex-col gap-3 px-3'>
        <div className={`hidetimes flex items-center gap-4 cursor-pointer px-3 py-1 ${ !showPost ? 'border-2 border-gray-600': null}`}>
         <div className="flex gap-3 items-center hover:text-blue-600 transition ease-in-out">
         <h4 className={ `${ showPost ? 'border-b-2 border-gray-800' : null} pb-1 font-medium text-md`}><Link to='/'>MeetUps</Link> </h4> 
